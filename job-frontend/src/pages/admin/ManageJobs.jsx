    ...
    <div>
      ...
      <div style={styles.header}>
        <div style={styles.headerLeft}>
          ...
          <div>
            <h2 style={styles.pageTitle}>Manage Jobs</h2>
            <p style={styles.pageSubtitle}>{filteredJobs.length} jobs found</p>
          </div>
        </div>
      </div>
            ...
            <div style={styles.jobDetails}>
              ...
              <div style={styles.jobDetailRow}>
                <span style={styles.detailLabel}>
                  ...
                  Recruiter: {job.recruiterEmail || "N/A"}
                </span>
              </div>
              <div style={styles.jobDetailRow}>
                <span style={styles.detailLabel}>Experience: {job.experienceRequired !== null && job.experienceRequired !== undefined ? `${job.experienceRequired} years` : "N/A"}</span>
                {job.jobType && (
                  <span style={{
                    ...styles.badge,
              ...
              <div style={styles.jobDetailRow}>
                ...
                <span style={styles.detailValue}>ID: #{job.id}</span>
              </div>
            </div>
